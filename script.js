...
if(data.wind.speed<=1){
	// wd.innerHTML="wind speed  "+data.wind.speed+"m/hr"
	wd.innerHTML=`<span id="io"><i class="fa-solid fa-wind"></i></span>wind-speed<p>${data.wind.speed}m/hr</p>`

}else{
	// wd.innerHTML="wind speed  "+data.wind.speed+"km/hr"
	// wd.innerHTML=`<span id="io"><i class="fa-solid fa-wind"></i></span><span id="ttt">wind-speed${data.wind.speed}km/hr</span>`
...
nam.innerHTML=data.name
deg.innerHTML=Math.round(data.main.temp)+"°"
hm.innerHTML=`Humidity  \n  ` +data.main.humidity+"% "

if(data.wind.speed<=1){
	wd.innerHTML=` wind speed  \n   ` +data.wind.speed+"m/hr"
